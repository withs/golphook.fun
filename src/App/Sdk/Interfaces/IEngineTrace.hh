...
#include "Sdk/Interfaces/Math/Vector4D.hpp"
...
{
    public:
         CTraceFilterPlayersOnlySkipOne(Entity_t* ent)
         {
             pEnt = ent;
         }
         bool ShouldHitEntity(IHandleEntity* pEntityHandle, int /*contentsMask*/)
         {
             return (Entity_t*)pEntityHandle != pEnt && ((Entity_t*)pEntityHandle)->GetClientClass()->m_ClassID == 40;
         }
         virtual TraceType GetTraceType() const
         {
             return TraceType::TRACE_ENTITIES_ONLY;
...
{
    public:
         CTraceFilterSkipTwoEntities(Entity_t* ent1, Entity_t* ent2)
         {
             pEnt1 = ent1;
             pEnt2 = ent2;
         }
         bool ShouldHitEntity(IHandleEntity* pEntityHandle, int /*contentsMask*/)
         {
             return !(pEntityHandle == pEnt1->handle() || pEntityHandle == pEnt2->handle());
         }
         virtual TraceType GetTraceType() const
         {
             return TraceType::TRACE_EVERYTHING;
